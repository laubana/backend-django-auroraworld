...
SECRET_KEY = 'django-insecure-fk&vu8o2z32nenkx$b5w!tkff%87$@16sn1=u%pb0gljr=q-&l'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost', 'auroraworld-backend.yuhwan-ban.link']
...
CORS_ALLOWED_ORIGINS = (ORIGINS or 'http://localhost:5173').split(',')
